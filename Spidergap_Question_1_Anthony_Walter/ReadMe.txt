...
Below are the restrictions researched of this cloning method.
...
changes within shared inner object changes, that change will be reflected in both
clones if shallow.  However, in deep cloning, any interior object will be duplicated
with memory addresses pointing to the duplicated object instead of the original;
thereby keeping the cloned object completely independent of the original object.
